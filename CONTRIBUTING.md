...
[![贡献人员](https://img.shields.io/github/contributors/eframework-io/Unite.Utility)](https://github.com/eframework-io/Unite.Utility/graphs/contributors)
[![月度提交](https://img.shields.io/github/commit-activity/m/eframework-io/Unite.Utility)](https://github.com/eframework-io/Unite.Utility/graphs/commit-activity)
[![最后提交](https://img.shields.io/github/last-commit/eframework-io/Unite.Utility)](https://github.com/eframework-io/Unite.Utility/commits/master)

[![活跃议题](https://img.shields.io/github/issues/eframework-io/Unite.Utility)](https://github.com/eframework-io/Unite.Utility/issues)
[![单元测试](https://github.com/eframework-io/Unite.Utility/actions/workflows/test.yml/badge.svg)](https://github.com/eframework-io/Unite.Utility/actions/workflows/test.yml)
[![版本发布](https://github.com/eframework-io/Unite.Utility/actions/workflows/publish.yml/badge.svg)](https://github.com/eframework-io/Unite.Utility/actions/workflows/publish.yml)

感谢您考虑为本项目做出贡献！

## 技术路线

- 编程语言：TypeScript 4.1.6（Node.js 16.11.7）
- 单元测试：XTest（Jest）
- 开发工具：VS Code
- 集成工具：Rollup、Github Actions
...
import { XTest } from "io.eframework.unite.utility"
...
- 克隆仓库
  ```bash
  git clone https://github.com/eframework-io/Unite.Utility.git
  cd Unite.Utility
  ```
...
- 目标工程中链接本地包
  ```bash
  npm link io.eframework.unite.utility
  ```
...
- 添加包引用至 package.json
  ...
  {
    "dependencies": {
      "io.eframework.unite.utility": "$version"
    }
  }
  ```
...
- 导入并执行测试
  ```typescript
  import { TestAll } from "io.eframework.unite.utility/test"
  ```
...
- 发布版本：运行[版本发布](https://github.com/eframework-io/Unite.Utility/actions/workflows/publish.yml)工作流

## 问题反馈

### 1. 问题检索
- 查阅[议题](https://github.com/eframework-io/Unite.Utility/issues)避免重复
- 确认可以稳定重现
- 提供必要环境信息
